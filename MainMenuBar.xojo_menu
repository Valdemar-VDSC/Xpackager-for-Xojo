...
Begin Menu MainMenuBar
   Begin DesktopMenuItem FileMenu
      ...
      Begin DesktopMenuItem FileNew
         ...
         Visible = True
      End
      Begin DesktopMenuItem FileNewFromTemplate
         SpecialMenu = 0
         Index = -2147483648
         Text = "#Loc.kNewFromTemplateEllipsis"
         AutoEnabled = True
         AutoEnable = True
         Visible = True
      End
      ...
      Begin DesktopMenuItem FileSaveAs
         ...
         Visible = True
      End
      Begin DesktopMenuItem FileSaveAsTemplate
         SpecialMenu = 0
         Index = -2147483648
         Text = "#Loc.kSaveProjectAsTemplate"
         AutoEnabled = True
         AutoEnable = True
         Visible = True
      End
      Begin DesktopMenuItem FileSeparator2
         ...
         Visible = True
      End
      Begin DesktopMenuItem FileBuild
         SpecialMenu = 0
         Index = -2147483648
         Text = "#Loc.kBuildEllipsis"
         ShortcutKey = "B"
         Shortcut = "Cmd+B"
         MenuModifier = True
         AutoEnabled = True
